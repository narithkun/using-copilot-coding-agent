...
def get_activities(
    ...
    - difficulty: Filter by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'unspecified' for activities with no specified difficulty)
    """
    ...
    if difficulty:
        if difficulty == "unspecified":
            # "unspecified" means activities with no difficulty specified
